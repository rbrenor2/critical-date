        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    MonthlyMarkdownBudget = table.Column<decimal>(type: "numeric", nullable: false),
                    UsedMarkdownBudget = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceChangeRequests_InventoryItems_InventoryItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceChangeRequests_InventoryItemId",
